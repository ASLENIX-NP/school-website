...
const pillars = [
  { icon: Award, label: "Academic Excellence", desc: "Rigorous curriculum aligned with international standards and board exams." },
  { icon: Heart, label: "Holistic Development", desc: "Sports, arts, music, and leadership programs for every student." },
  { icon: Lightbulb, label: "Innovation Culture", desc: "STEM labs, maker spaces, and design thinking workshops." },
];
...
export function About() {
  return (
    <section id="about" className="py-28 relative overflow-hidden" style={{ background: "#fdf8f3" }}>
      {/* Background blob */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            More Than a School —{" "}
            <span className="italic" style={{ color: "#6b21a8" }}>A Community</span>
          </h2>
          <p className="max-w-2xl mx-auto text-lg" style={{ color: "#64748b" }}>
            Founded in 1989, Apex Academy has shaped over 35,000 graduates who lead in science, business, arts, and public service across 60 countries.
          </p>
        </motion.div>
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{ background: "linear-gradient(to top, rgba(15,28,63,0.5) 0%, transparent 50%)" }}
              />
            </div>
            ...
            >
              ...
              <div className="text-white font-semibold text-sm">National School of the Year</div>
              <div className="text-xs mt-1" style={{ color: "#f97316" }}>2023 & 2024</div>
            </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-semibold" style={{ color: "#0f1c3f" }}>NEASC Accredited</div>
                  <div className="text-xs" style={{ color: "#64748b" }}>Since 2001</div>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-5 mb-10">
              {pillars.map((p) => (
                <div
                  ...
                  style={{ background: "#ffffff", border: "1px solid rgba(15,28,63,0.08)" }}
                >
                  <div
                  ...
                  <div>
                    <div className="font-semibold mb-1" style={{ color: "#0f1c3f" }}>{p.label}</div>
                    <div className="text-sm" style={{ color: "#64748b" }}>{p.desc}</div>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {highlights.map((h) => (
                <div key={h} className="flex items-start gap-2">
                  ...
                  <span className="text-sm" style={{ color: "#475569" }}>{h}</span>
                </div>
              ))}
            </div>
            ...
            <div className="mt-10">
              <a
                ...
                style={{ background: "linear-gradient(135deg, #0f1c3f, #1a0a3c)", boxShadow: "0 8px 24px rgba(15,28,63,0.3)" }}
              >
